...
import FloatingManageDevButton from "../Ui/FloatingManageDevButton";
    ...
    <>
      ...
      >
        <div className="relative flex items-center justify-center max-w-6xl mx-auto px-4">
          {/* Title */}
          <h2 className="text-5xl font-bold font-heading text-yellow-600 text-center">
            Developers
          </h2>
          ...
          {isAdmin && (
            <button
              onClick={() => navigate("/admin/manageDevelopers")}
              className="cursor-pointer absolute right-0 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-semibold px-4 py-2 rounded-full shadow-md transition-all duration-300 hover:scale-105 "
            >
              Manage Devs
            </button>
          )}
